...
./interval2matrix.py -gtf geneSet.v4_0.gtf --fix-chrome -bed broad.mit.edu_TGCT_Genome_Wide_SNP_6.hg19.cna.bed > broad.mit.edu_TGCT_Genome_Wide_SNP_6.hg19.cna.matrix
```
